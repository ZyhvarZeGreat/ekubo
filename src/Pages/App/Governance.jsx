    ...
    return (
        <div className="chakra-container css-1a6mv67">
            <div className="css-1qnsqca">
                <h2 className="chakra-heading css-50m4dq">Proposals</h2>
                <div
                    role="group"
                ...
                >
                    <a
                        className="chakra-button css-o8mhz8"
                        href="/governance/simple-delegate"
                    >
                        Delegate
                    </a>
                    <a
                        className="chakra-button css-46cfkt"
            ...
            <div className="chakra-stack css-1153lrp">
                <div className="chakra-card css-scnhj">
                    <div className="chakra-card__header css-19vz6j1">
                        <div className="css-0">
                            <h2 className="chakra-heading css-10ja9vs">
                    ...
                    <div className="css-wv05um">
                        <div className="css-13xhnxm">
                            <h2 className="chakra-heading css-3v8zav">Calls</h2>
                        </div>
                ...
                <div className="chakra-card css-scnhj">
                    ...
                    />
                    <div className="chakra-card__body css-1idwstw">
                        <h2 className="chakra-heading css-1jpoxap">Abstract</h2>
                        <p className="chakra-text css-ul7620">
                ...
                <div className="chakra-card css-scnhj">
                    ...
                    <div className="css-wv05um">
                        ...
                        <div className="css-gmuwbf">
                            <button type="button" className="chakra-button css-2jd4x9">
                                Show all
                            </button>
                        </div>
                    </div>
                ...
                <div className="chakra-card css-scnhj">
                    ...
                    <div className="chakra-card__body css-1idwstw">
                        ...
                        <h2 className="chakra-heading css-1jpoxap">
            ...
            <div className="css-13rl60n">
                <div className="css-gg4vpm">
                    ...
                    >
                        <button
                            type="button"
                            className="chakra-button css-1n6eqmp"
